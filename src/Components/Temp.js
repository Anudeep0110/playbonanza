  ...
  return (
    ...
    <div className="text-white d-flex flex-column justify-content-center align-items-start flex-wrap" style={{ minHeight: '100vh', width: '100vw', paddingTop: 100 }}>
      ...
      <div className="d-flex justify-content-center">
        <div className="d-flex mt-5 align-items-center" style={{ width: "100%", maxWidth: "600px", overflow: "hidden" }}>
          <WheelComponent
            segments={segments}
            segColors={segColors}
      ...
      <div className="d-flex flex-column px-5 align-items-start" style={{ gap: 20 }}>
        <div className="d-flex justify-content-center" style={{ width: "100%" }}>
          <img src={require('../Assets/Logo.png')} alt="Logo" style={{ width: "100%", maxWidth: "200px" }} className="text-center"></img>
        </div>
